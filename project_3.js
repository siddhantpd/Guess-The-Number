...
// const userGuess = userNum.value

// let count = 10;
// submitGuess.addEventListener("click", (e) => {
//     e.preventDefault()
//     const userGuess = parseInt(userNum.value)
//     previousGuess.innerHTML = userGuess
//     evaluateGuess(userGuess, compGuess)
//     count--
//     remainingGuess.innerHTML = count
//     console.log(count)
//     if(count === 0) {
//         submitGuess.disabled = true;
//         printResult.innerHTML = "Reload the page to play again"
//     }
// })

// const evaluateGuess = (userGuess, compGuess) => {
